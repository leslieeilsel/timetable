    ...
    public function inspect(Semester $semester): array
    {
        ...
        return [
            ...
            'summary' => [
                ...
                'active_class_settings' => $activeClassSettings,
                'confirmed_assignments' => $confirmedCount,
                'assignment_resource_issues' => count($resourceIssues),
                ...
                'active_constraints' => $hardCount + $softCount,
                'current_version_count' => $currentVersion === null ? 0 : 1,
            ],
            'checks' => $checks,
        ];
    }
