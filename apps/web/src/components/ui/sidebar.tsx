...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 flex-col gap-1 px-2.5 py-1 group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSubButton({
  ...
  return useRender({
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          "flex h-9 min-w-0 items-center gap-2.5 overflow-hidden rounded-lg px-3 text-sidebar-foreground ring-sidebar-ring outline-hidden group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-3 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[size=md]:text-sm data-[size=sm]:text-xs data-active:bg-primary/[0.08] data-active:font-semibold data-active:text-primary [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
          className,
        ),
      },
      props,
